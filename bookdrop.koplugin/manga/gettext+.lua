...
-- Bookdrop bundles this plugin under bookdrop.koplugin/manga/, so the l10n
-- directory is derived from this file's own location instead of upstream's
-- hardcoded path (which assumed a standalone install at plugins/rakuyomi.koplugin).
-- This is the only modification to the vendored code.
local function pluginDirname()
