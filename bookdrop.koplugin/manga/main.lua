...
-- Bookdrop bundles this plugin: the Bookdrop store's Manga tab is the single
-- entry point, so the plugin's own main-menu entry is suppressed.
-- (Second modification to the vendored code; see README.md.)
